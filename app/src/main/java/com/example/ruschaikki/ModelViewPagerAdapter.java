package com.example.ruschaikki;
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (modelViewPagerList.get(position).getBouncher().toLowerCase().startsWith("тема") ||
                    modelViewPagerList.get(position).getBouncher().toLowerCase().startsWith("тесты") ||
                        modelViewPagerList.get(position).getBouncher().toLowerCase().startsWith("глоссарий")
